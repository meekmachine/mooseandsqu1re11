...
(function () {
    ...
    var a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v, w, x, y, z, A, B = [].slice, C = [].indexOf || function (a) {
    ...
    r = {}, "undefined" != typeof window && (window.HTMLString = r), "undefined" != typeof module && module.exports && (z = module.exports = r), r.String = function () {
        ...
        return a._parser = null, a.prototype.isWhitespace = function () {
            var a, b, c, d;
            for (d = this.characters, b = 0, c = d.length; c > b; b++)if (a = d[b], !a.isWhitespace())return !1;
            return !0
            ...
            for (g = 2 <= arguments.length ? B.call(arguments, 0, i = arguments.length - 1) : (i = 0, []), c = arguments[i++], "undefined" != typeof c && "boolean" != typeof c && (g.push(c), c = !0), e = this.copy(), j = 0, m = g.length; m > j; j++)if (f = g[j], 0 !== f.length) {
                if (h = f, "string" == typeof f && (h = new r.String(f, this._preserveWhitespace)), c && e.length())for (b = e.charAt(e.length() - 1), d = b.tags(), b.isTag() && d.shift(), "string" != typeof f && (h = h.copy()), p = h.characters, k = 0, n = p.length; n > k; k++)a = p[k], a.addTags.apply(a, d);
            ...
            for (d = 0; d <= this.length() - a.length();) {
                for (c = !0, h = a.characters, e = f = 0, g = h.length; g > f; e = ++f)if (b = h[e], !b.eq(this.characters[e + d])) {
                    c = !1;
                    break
                }
                if (c)return !0;
            ...
            for (c = this.characters.slice().reverse(), g = a.characters.slice().reverse(), d = e = 0, f = g.length; f > e; d = ++e)if (b = g[d], !b.eq(c[d]))return !1;
            return !0
            ...
            var a, b, c, d, e, f, g, h;
            for (d = 2 <= arguments.length ? B.call(arguments, 0, e = arguments.length - 1) : (e = 0, []), c = arguments[e++], "undefined" != typeof c && "boolean" != typeof c && (d.push(c), c = !1), b = !1, h = this.characters, f = 0, g = h.length; g > f; f++)if (a = h[f], a.hasTags.apply(a, d))b = !0; else if (c)return !1;
            return b
            ...
            for (e = "", h = [], f = [], c = [], t = this.characters, j = 0, n = t.length; n > j; j++) {
                for (a = t[j], c = [], u = h.slice().reverse(), k = 0, o = u.length; o > k; k++)if (g = u[k], c.push(g), !a.hasTags(g)) {
            ...
            for (; b <= this.length() - a.length();) {
                for (d = !0, h = a.characters, e = f = 0, g = h.length; g > f; e = ++f)if (c = h[e], !c.eq(this.characters[e + b])) {
                    d = !1;
                    break
                }
                if (d)return b;
            ...
            if (null == c && (c = !0), e = this.slice(0, a), j = this.slice(a), 0 > a && (a = this.length() + a), h = b, "string" == typeof b && (h = new r.String(b, this._preserveWhitespace)), c && a > 0)for (f = this.charAt(a - 1), g = f.tags(), f.isTag() && g.shift(), "string" != typeof b && (h = h.copy()), q = h.characters, k = 0, n = q.length; n > k; k++)d = q[k], d.addTags.apply(d, g);
            ...
            if (null == b && (b = 0), 0 > b && (b = 0), d = this.characters.slice(b).reverse(), b = 0, "string" == typeof a) {
                ...
                for (a = a.split("").reverse(); b <= d.length - a.length;) {
                    for (e = !0, g = 0, f = h = 0, j = a.length; j > h; f = ++h)if (c = a[f], d[f + b].isTag() && (g += 1), c !== d[g + f + b].c()) {
                        e = !1;
                        break
                    }
                    if (e)return b;
            ...
            for (a = a.characters.slice().reverse(); b <= d.length - a.length;) {
                for (e = !0, f = i = 0, k = a.length; k > i; f = ++i)if (c = a[f], !c.eq(d[f + b])) {
                    e = !1;
                    break
                }
                if (e)return b;
            ...
            for (i = [], g = [], e = null, D = this.characters.slice().reverse(), p = 0, t = D.length; t > p; p++) {
                for (a = D[p], a._runLengthMap = {}, a._runLengthMapSize = 0, c = [], E = i.slice().reverse(), q = 0, u = E.length; u > q; q++)if (h = E[q], c.push(h), !a.hasTags(h)) {
            ...
            for (k = function (a, b) {
                return b[1] - a[1]
            }, G = this.characters, J = [], B = 0, y = G.length; y > B; B++)if (a = G[B], f = a._tags.length, !(f > 0 && a._tags[0].selfClosing() && 3 > f || 2 > f)) {
                l = [], H = a._runLengthMap;
            ...
            for (f = a.characters, c = d = 0, e = f.length; e > d; c = ++d)if (b = f[c], !b.eq(this.characters[c]))return !1;
            return !0
        ...
        return z.prototype._back = function () {
            ...
            for (var a, b; ;)if (b = this.tags.pop(), this.string.length() && (a = this.string.characters[this.string.length() - 1], a.isTag() || a.isEntity() || !a.isWhitespace() || a.removeTags(b)), b.name() === this.tagName.toLowerCase())break;
            return this.tagName = ""
    ...
    a = {}, a.Range = function () {
        ...
        if (k === a)for (k = e[e.length - 1], l = k.textContent.length, j = n = 0, p = e.length; p > n; j = ++n)if (d = e[j], 1 === m.comparePoint(d, 0)) {
            0 === j ? (k = d, l = 0) : (k = e[j - 1], l = d.textContent.length), r = k.nodeName.toLowerCase, h.call(b, r) >= 0 && (l = 1);
            break
        }
        if (c.collapsed)return [k, l, k, l];
        if (f === a)for (f = e[e.length - 1], g = f.textContent.length, j = o = 0, q = e.length; q > o; j = ++o)d = e[j], 1 === i.comparePoint(d, 0) && (f = 0 === j ? d : e[j - 1], g = d.textContent.length + 1);
        return [k, l, f, g]
    }, "undefined" != typeof window && (window.ContentSelect = a), "undefined" != typeof module && module.exports && (c = module.exports = a)
}.call(this), function () {
    var a, b, c, d, e, f = [].slice, g = [].indexOf || function (a) {
            for (var b = 0, c = this.length; c > b; b++)if (b in this && this[b] === a)return b;
            return -1
    ...
    a = {
        ALIGNMENT_CLASS_NAMES: {left: "align-left", right: "align-right"},
        ...
        return b.prototype.lastModified = function () {
            ...
            var b;
            for (b = this; b;)if (b = b.next(), b && a(b))return b
            ...
            var b;
            for (b = this; b;)if (b = b.previous(), b && a(b))return b
        }, b.extend = function (a) {
            var b, c, d;
            d = a.prototype;
        ...
        return i(c, b), c.prototype.attributes = function () {
            ...
            return d
        }, c.prototype._onKeyDown = function () {
        }, c.prototype._onKeyUp = function () {
        }, c.prototype._onMouseDown = function () {
        ...
        }, c.prototype._onNativeDrop = function (b) {
        ...
        }, c.droppers = {Static: a.Element._dropVert}, c.fromDOMElement = function (a) {
        ...
        return i(c, b), c.prototype.cssTypeName = function () {
            ...
            var a;
            if (this.isMounted() && this._syncContent(), this.content.isWhitespace() && this.can("remove"))this.parent() && this.parent().detach(this); else if (this.isMounted()) {
                try {
            ...
            var c, d, e, f, g, h;
            if (b.preventDefault(), !(this.content.isWhitespace() && !b.shiftKey ^ a.PREFER_LINE_BREAKS)) {
            ...
            return b.preventDefault(), this.isFixed() ? b.shiftKey ? a.Root.get().trigger("previous-region", this.closest(function (a) {
                return "Fixture" === a.type() || "Region" === a.type()
            })) : a.Root.get().trigger("next-region", this.closest(function (a) {
                return "Fixture" === a.type() || "Region" === a.type()
            })) : void 0
        ...
        }, c.droppers = {Static: a.Element._dropVert, Text: a.Element._dropVert}, c.mergers = {
            Text: function (a, b) {
                var c;
        ...
        return i(c, b), c.prototype.cssTypeName = function () {
            ...
            if (b = null, "a" === a.tagName.toLowerCase()) {
                for (b = this.getDOMElementAttributes(a), f = function () {
                    ...
                    return f
                }(), g = 0, h = f.length; h > g; g++)if (e = f[g], 1 === e.nodeType && "img" === e.tagName.toLowerCase()) {
                    a = e;
                    break
                }
        ...
        return i(c, b), c.prototype.cssTypeName = function () {
            ...
            var a, b, c, d, e, f;
            if (this.parent()) {
                if (c = this.parent().children.indexOf(this), this.list())for (f = this.list().children.slice(), b = d = 0, e = f.length; e > d; b = ++d)a = f[b], a.parent().detach(a), this.parent().attach(a, b + c);
            ...
            if (this.can("indent")) {
                ...
                if (l = new a.Text("p", this.attr("class") ? {"class": this.attr("class")} : {}, this.listItemText().content), i = null, this.listItemText().isFocused() && (i = ContentSelect.Range.query(this.listItemText().domElement())), h = c.children.indexOf(g), e = g.children.indexOf(this), 0 === e) {
                    if (f = null, 1 === g.children.length ? (this.list() && (f = new a.List(g.tagName())), c.detach(g)) : g.detach(this), c.attach(l, h), f && c.attach(f, h + 1), this.list())for (u = this.list().children.slice(), d = n = 0, r = u.length; r > n; d = ++n)b = u[d], b.parent().detach(b), f ? f.attach(b) : g.attach(b, d)
                } else if (e === g.children.length - 1)g.detach(this), c.attach(l, h + 1), this.list() && c.attach(this.list(), h + 2); else {
                    if (g.detach(this), c.attach(l, h + 1), f = new a.List(g.tagName()), c.attach(f, h + 2), this.list())for (v = this.list().children.slice(), o = 0, s = v.length; s > o; o++)b = v[o], b.parent().detach(b), f.attach(b);
        ...
        }, c.prototype._removeDOMEventListners = function () {
        }, c.fromDOMElement = function (b) {
        ...
        return i(c, b), c.prototype.cssTypeName = function () {
            ...
            var c, d, e, f, g, h;
            return b.preventDefault(), this.content.isWhitespace() ? void this.parent().unindent() : this.can("spawn") ? (ContentSelect.Range.query(this._domElement), f = ContentSelect.Range.query(this._domElement), h = this.content.substring(0, f.get()[0]), g = this.content.substring(f.get()[1]), h.length() + g.length() === 0 ? void this.parent().unindent() : (this.content = h.trim(), this.updateInnerHTML(), c = this.parent().parent(), e = new a.ListItem(this.attr("class") ? {"class": this.attr("class")} : {}), c.attach(e, c.children.indexOf(this.parent()) + 1), e.attach(new a.ListItemText(g.trim())), d = this.parent().list(), d && (this.parent().detach(d), e.attach(d)), h.length() ? (e.listItemText().focus(), f = new ContentSelect.Range(0, 0), f.select(e.listItemText().domElement())) : (f = new ContentSelect.Range(0, h.length()), f.select(this._domElement)), this.taint())) : void 0
        }, c.droppers = {
            ListItemText: function (b, c, d) {
                ...
                var e, f, g, h, i;
                if ("Text" === b.type()) {
                    if (h = c.parent(), b.parent().detach(b), e = b.attr("class"), g = new a.ListItem(e ? {"class": e} : {}), g.attach(new a.ListItemText(b.content)), h.list() && "below" === d[0])return void h.list().attach(g, 0);
                ...
                } else if (e = b.attr("class"), i = new a.Text("p", e ? {"class": e} : {}, b.content), b.parent().remove(), f = c.parent().children.indexOf(c), "below" === d[0] && (f += 1), c.parent().attach(i, f), i.focus(), b._savedSelection)return b._savedSelection.select(i.domElement())
            }
        }, c.mergers = {
        ...
        return i(c, b), c.prototype.cssTypeName = function () {
            ...
            var b, c, d, e;
            for (e = this.children, c = 0, d = e.length; d > c; c++)if (b = e[c], b.tagName() === a)return b;
            return null
        }, c.droppers = {
            Image: a.Element._dropBoth,
            List: a.Element._dropVert,
            ...
            for (i = new this(this.getDOMElementAttributes(b)), e = function () {
                ...
                for (e = b.childNodes, f = [], a = 0, d = e.length; d > a; a++)c = e[a], f.push(c);
                return f
            }(), f = [], k = 0, m = e.length; m > k; k++)if (d = e[k], 1 === d.nodeType && (j = d.tagName.toLowerCase(), !i._getChild(j)))switch (j) {
                case"tbody":
                case"tfoot":
                case"thead":
            ...
            if (f.length > 0)for (i._getChild("tbody") || i.attach(new a.TableSection("tbody")), l = 0, n = f.length; n > l; l++)g = f[l], i.tbody().attach(g);
        ...
        return i(c, b), c.prototype.cssTypeName = function () {
            ...
            var a, b, c, d, e;
            for (e = this.children, c = 0, d = e.length; d > c; c++)if (a = e[c], b = a.tableCellText(), b && b.content.length() > 0)return !1;
            return !0
        }, c.prototype.type = function () {
            return "TableRow"
        }, c.prototype.typeName = function () {
            ...
            return c.__super__._onMouseOver.call(this, a), this._removeCSSClass("ce-element--over")
        }, c.droppers = {TableRow: a.Element._dropVert}, c.fromDOMElement = function (b) {
            var c, d, e, f, g, h, i;
        ...
        return i(c, b), c.prototype.cssTypeName = function () {
            ...
            return a.preventDefault(), this._keyTab({
                shiftKey: !1, preventDefault: function () {
                }
            })
        }, c.prototype._keyTab = function (b) {
            var c, d, e, f, g, h, i, j, k, l;
    ...
    var a, b, c, d, e, f, g = {}.hasOwnProperty, h = function (a, b) {
        function c() {
            this.constructor = a
        }
    ...
    b = {
        ...
        }, a.prototype.removeCSSClass = function (a) {
        ...
        }, a.prototype._addDOMEventListeners = function () {
        }, a.prototype._removeDOMEventListeners = function () {
        }, a.createDiv = function (a, b, c) {
            var d, e, f;
            if (d = document.createElement("div"), a && a.length > 0 && d.setAttribute("class", a.join(" ")), b)for (e in b)f = b[e], d.setAttribute(e, f);
        ...
        return h(b, a), b.prototype.busy = function (a) {
            if (this.dispatchEvent(this.createEvent("busy", {busy: a}))) {
            ...
            if (this._state !== a && this.dispatchEvent(this.createEvent("statechange", {state: a})))return this._state = a, this.removeCSSClass("ct-ignition--busy"), this.removeCSSClass("ct-ignition--editing"), this.removeCSSClass("ct-ignition--ready"), "busy" === this._state ? this.addCSSClass("ct-ignition--busy") : "editing" === this._state ? this.addCSSClass("ct-ignition--editing") : "ready" === this._state ? this.addCSSClass("ct-ignition--ready") : void 0
        ...
        return h(c, a), c.prototype.mount = function (a, b) {
            return null == b && (b = null), this._domElement = this.constructor.createDiv(["ct-tag"]), this._domElement.textContent = this.element.tagName(), c.__super__.mount.call(this, a, b)
        }, c.prototype._addDOMEventListeners = function () {
        ...
        return h(c, a), c.prototype.isDragging = function () {
            ...
            return this._domGrip.addEventListener("mousedown", this._onStartDragging), this._handleResize = function (a) {
                ...
                return function (a) {
                    ...
                    return g && b.Tools.Undo.canApply(null, null) && b.Tools.Undo.apply(null, null, function () {
                    }), f && b.Tools.Redo.canApply(null, null) ? b.Tools.Redo.apply(null, null, function () {
                    }) : void 0
                }
        ...
        return h(b, a), b.prototype.apply = function (a, b) {
            var c, d;
            if (this.tool.canApply(a, b))return d = {element: a, selection: b}, c = function (a) {
                return function (b) {
        ...
        return h(d, a), d.prototype.cropRegion = function () {
            ...
            return this.dispatchEvent(this.createEvent("save", {imageURL: a, imageSize: b, imageAttrs: c}))
            ...
            return d.__super__._addDOMEventListeners.call(this), this._domInput.addEventListener("change", function (a) {
                return function (b) {
                    var c;
                    return c = b.target.files[0], b.target.value = "", b.target.value && (b.target.type = "text", b.target.type = "file"), a.dispatchEvent(a.createEvent("imageuploader.fileready", {file: c}))
                }
        ...
        return h(b, a), c = "_blank", b.prototype.mount = function () {
            ...
            var a;
            return this.isMounted() ? (a = {href: this._domInput.value.trim()}, this._target && (a.target = this._target), this.dispatchEvent(this.createEvent("save", a))) : void this.dispatchEvent(this.createEvent("save"))
        }, b.prototype.show = function () {
        ...
        return h(c, a), c.prototype.clearPreview = function () {
            ...
            var a, c;
            return c = this._domInput.value.trim(), a = b.getEmbedVideoURL(c), this.dispatchEvent(a ? this.createEvent("save", {url: a}) : this.createEvent("save", {url: c}))
        ...
        return h(c, a), c.prototype.ctrlDown = function () {
            ...
            return null == c && (c = "id"), null == d && (d = null), null == e && (e = !0), this._namingProp = c, d && (this._fixtureTest = d), this.mount(), e && (this._ignition = new b.IgnitionUI, this.attach(this._ignition), this._ignition.addEventListener("edit", function (a) {
                ...
                return function (b) {
                    ...
                    if (f = a.orderedRegions(), e = f.indexOf(b), !(e >= f.length - 1)) {
                        for (b = f[e + 1], d = null, i = b.descendants(), g = 0, h = i.length; h > g; g++)if (c = i[g], void 0 !== c.content) {
                            d = c;
                            break
                        }
                ...
                return function (b) {
                    ...
                    if (h = a.orderedRegions(), f = h.indexOf(b), !(0 >= f)) {
                        for (b = h[f - 1], e = null, d = b.descendants(), d.reverse(), i = 0, j = d.length; j > i; i++)if (c = d[i], void 0 !== c.content) {
                            e = c;
                            break
                        }
            ...
            if (this.dispatchEvent(this.createEvent("save", {passive: a}))) {
                ...
                return this.dispatchEvent(this.createEvent("saved", {regions: d, passive: a}))
            }
            ...
            var b;
            if (this.dispatchEvent(this.createEvent("stop", {save: a}))) {
                if (b = ContentEdit.Root.get().focused(), b && b.isMounted() && void 0 !== b._syncContent && b._syncContent(), a)this.save(); else if (!this.revert())return;
            ...
            if (!this._emptyRegionsAllowed) {
                i = this._regions, k = [];
                for (d in i) {
                    for (f = i[d], c = f.lastModified(), b = !1, j = f.children, g = 0, h = j.length; h > g; g++)if (a = j[g], "Static" !== a.type()) {
                        b = !0;
                        break
                    }
        ...
        return a.prototype.canRedo = function () {
            ...
            var a, b, c, d, e, f, g;
            e = {regions: {}, selected: null}, f = this._regions;
        ...
        return h(c, a), b.ToolShelf.stow(c, "link"), c.label = "Link", c.icon = "link", c.tagName = "a", c.getAttr = function (a, b, c) {
            ...
            if ("Image" === b.type()) {
                if (b.a)return b.a[a]
            } else for (m = c.get(), e = m[0], h = m[1], f = b.content.slice(e, h), n = f.characters, i = 0, k = n.length; k > i; i++)if (d = n[i], d.hasTags("a"))for (o = d.tags(), j = 0, l = o.length; l > j; j++)if (g = o[j], "a" === g.name())return g.attr(a);
            return ""
            ...
            if (g = !1, "Image" === a.type())o = a.domElement().getBoundingClientRect(); else {
                if (c.isCollapsed()) {
                ...
                a.storeState(), r = new HTMLString.Tag("span", {"class": "ct--puesdo-select"}), v = c.get(), l = v[0], t = v[1], a.content = a.content.format(l, t, r), a.updateInnerHTML(), j = a.domElement(), m = j.getElementsByClassName("ct--puesdo-select"), o = m[0].getBoundingClientRect()
            }
            return f = b.EditorApp.get(), n = new b.ModalUI(u = !0, e = !0), n.addEventListener("click", function () {
                ...
                if (f = b.detail(), g = !0, "Image" === a.type()) {
                    if (d = ["align-center", "align-left", "align-right"], f.href) {
                        for (a.a = {href: f.href}, a.a && (a.a["class"] = a.a["class"]), f.target && (a.a.target = f.target), i = 0, k = d.length; k > i; i++)if (e = d[i], a.hasCSSClass(e)) {
                            a.removeCSSClass(e), a.a["class"] = e;
                            break
                        }
                    } else {
                        for (h = [], a.a["class"] && (h = a.a["class"].split(" ")), j = 0, m = d.length; m > j; j++)if (e = d[j], h.indexOf(e) > -1) {
                            a.addCSSClass(e);
                            break
                        }
                        a.a = null
        ...
        return h(c, a), b.ToolShelf.stow(c, "align-left"), c.label = "Align left", c.icon = "align-left", c.className = "text-left", c.canApply = function (a) {
            ...
            var e, f, g, h, i;
            for (("ListItemText" === (i = a.type()) || "TableCellText" === i) && (a = a.parent()), e = [b.Tools.AlignLeft.className, b.Tools.AlignCenter.className, b.Tools.AlignRight.className], g = 0, h = e.length; h > g; g++)if (f = e[g], a.hasCSSClass(f) && (a.removeCSSClass(f), f === this.className))return d(!0);
        ...
        return h(c, a), b.ToolShelf.stow(c, "table"), c.label = "Table", c.icon = "table", c.canApply = function (a) {
            ...
            var c, d, e, f, g, h, i;
            if (!a.head && b.thead() && b.detach(b.thead()), !a.foot && b.tfoot() && b.detach(b.tfoot()), c = b.firstSection().children[0].children.length, a.columns !== c)for (i = b.children, g = 0, h = i.length; h > g; g++)f = i[g], this._adjustColumns(f, a.columns);
